...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(img, "class", "background place-self-center svelte-2yoeug");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(h1, "class", "title justify-self-center font-black svelte-2yoeug");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div3, "class", "home page p-6 svelte-2yoeug");
...
class Home extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-2yoeug-style")) add_css();
...
//# sourceMappingURL=bundle.75c07044245c9a2e8f73.hot-update.js.map