...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(h1, "class", "title text-8xl justify-self-center font-black svelte-s3q8m2");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div3, "class", "home page p-6 svelte-s3q8m2");
...
class Home extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-s3q8m2-style")) add_css();
...
//# sourceMappingURL=bundle.75e649d1625f4e8a162a.hot-update.js.map