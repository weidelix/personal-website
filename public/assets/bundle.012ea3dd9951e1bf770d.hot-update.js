...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(h1, "class", "title text-8xl justify-self-center font-black svelte-nnqr3");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div3, "class", "home page p-6 svelte-nnqr3");
...
class Home extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-nnqr3-style")) add_css();
...
//# sourceMappingURL=bundle.012ea3dd9951e1bf770d.hot-update.js.map