...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(h1, "class", "title text-8xl justify-self-center font-black svelte-1357jnk");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div3, "class", "home page p-6 svelte-1357jnk");
...
class Home extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-1357jnk-style")) add_css();
...
//# sourceMappingURL=bundle.97aae5d1a478f08f9c02.hot-update.js.map