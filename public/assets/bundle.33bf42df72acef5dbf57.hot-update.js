...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(h1, "class", "title text-8xl justify-self-center font-black svelte-j8dycv");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div3, "class", "home page p-6 svelte-j8dycv");
...
class Home extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-j8dycv-style")) add_css();
...
//# sourceMappingURL=bundle.33bf42df72acef5dbf57.hot-update.js.map